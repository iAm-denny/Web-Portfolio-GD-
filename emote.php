...
<head>
	...
	<link rel="stylesheet" type="text/css" href="emotecode.css">
...
<!--//////////////////////////////////////////////////-->
	...
	<div class="row" id="main">
		<div class="col-lg-4 p-3" align="center" id="li1">
			<img src="admin/emoteimg/<?php echo $img;?>" width="220px" height="220px" id="img">
		...
		<div class="col-lg-4" id="intro" align="center" >
			...
			<li><a href="<?php echo $link?>"><?php echo $head?>&nbsp Video</li>
		...
		<div class="col-lg-4" align="center" id="li2">
					<div id="buy">
				<a href="shop4.php?emote=<?php echo $id ?>" >Buy V-Buck</a>
					</div>
				</div>
	</div>
