...
$id=$_GET['id'];
$sql="SELECT * FROM addskin where id='".$id."'";
...
<body>
	<form action="editadmindata.php?id2=<?php echo $id?>" method="post" id="main">
		...
		<div class="edit">Categories<input type="text" name="categories" value="<?php echo $categories?>"></div>
		<!--<div>Images<input type="file" name="imge" value="<?php echo $img?>"></div>-->
		<div class="sub"><input type="submit" name="edit" value="Edit"></div>
