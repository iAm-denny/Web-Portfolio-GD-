...
<div class="container">
	...
	<div class="row" id="main">
		<div class="col-lg-4" align="center" id="li1">
			<img src="skinimg/<?php echo $img;?>" width="220px" height="220px" id="img">
		...
		<div class="col-lg-4" id="intro" align="center" >
			...
			<li>Categories:&nbsp&nbsp<?php echo $categories?></li>
			

		
			</ul>
			<div class="as"><a href="addskin.php" >ADD Skin</a></div>
			<div class="as"><a href="editskin.php?id=<?php echo $id ?>">Edit</a></div>
			<div class="as"><a href="skindel.php?del=<?php echo $id ?>" >Delete</a></div>
		</div>
