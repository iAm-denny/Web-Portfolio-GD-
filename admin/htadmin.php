...
<!--////////////////////////////////////////////////////////-->
	...
	<div class="row" id="main">
		<div class="col-lg-4" align="center" id="li1">
			<img src="htimg/<?php echo $img;?>" width="220px" height="220px" id="img">
		...
		<div class="col-lg-4" id="intro" align="center" >
			...
			<div class="as"><a href="addht.php" >AddHarvest</a></div>
			<div class="as"><a href="editht.php?idh=<?php echo $id ?>">Edit</a></div>
			<div class="as"><a href="htdel.php?delh=<?php echo $id ?>" >Delete</a></div>
		</div>
