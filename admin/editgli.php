...
$id=$_GET['idg'];
$sql="SELECT * FROM gli where id='".$id."'";
...
<body>
	<form action="editglidata.php?idg=<?php echo $id?>" method="post" id="main">
		...
		<div class="sub"><input type="submit" name="editg" value="Edit"></div>
