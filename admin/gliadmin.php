...
<div class="container">
	...
	<div class="row" id="main">
		<div class="col-lg-4" align="center" id="li1">
			<img src="gliimg/<?php echo $img;?>" width="220px" height="220px" id="img">
		...
		<div class="col-lg-4" id="intro" align="center" >
			...
			<div class="as"><a href="addgli.php" >ADD Skin</a></div>
			<div class="as"><a href="editgli.php?idg=<?php echo $id ?>">Edit</a></div>
			<div class="as"><a href="glidel.php?delg=<?php echo $id ?>" >Delete</a></div>
		</div>
