...
<body>
	...
	<form action="addemotedata.php" method="post" enctype="multipart/form-data" id="main">
		...
		<div class="add">Link<input type="text" name="link" required></div>
