...
<html>
<head>
	<title>Harvestimg Tools</title>
	<link rel="stylesheet" type="text/css" href="style.css">
	<link rel="stylesheet" type="text/css" href="htcode.css">
...
<!--//////////////////////////////////////////////////-->
	...
	<div class="row" id="main">
		<div class="col-lg-4 p-3" align="center" id="li1">
			<img src="admin/htimg/<?php echo $img;?>" width="220px" height="220px" id="img">
		...
		<div class="col-lg-4" align="center" id="li2">
					<div id="buy">
				<a href="shop2.php?ht=<?php echo $id?>" >Buy V-Buck</a>
					</div>
				</div>
	</div>
